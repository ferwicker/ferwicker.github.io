...
},
{
    ...
    description: `<p>Eat-Da-Burger is a full stack web application deployed on Heroku. The application allows users to add their dream burgers to the database, and to mark them off as 'Devoured'.</p>
...
},
{
    ...
    description: `<p>This weather dashboard presents basic weather information for any city in the world in a visually pleasant format and is easy to use.</p>
...
},
{
    ...
    description: `<p>Travlmate was a collaboration project, built using HTML, CSS and Javascript with UI Kit as a CSS framework adn JQuery, and information from three different API's to gather the information that gets dynamically displayed.</p>
...
},
{
    ...
    description: `<p>As with every project, the first step is doing some brainstorming about possible approaches and putting some ideas down on paper as rough (very rough!) sketches.</p>
