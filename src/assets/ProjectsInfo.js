...
},
{
    ...
    screenshot2: 'team-illustration.png',
    technologies: ['React', 'Javascript', 'Bootstrap'],
    shortIntro: 'TeamSpark is an employee directory management app that helps organisations access their employees contact details easily.',
...
},
{
    ...
    shortIntro:'Taking inspiration from the ‘Before I Die’ global art project, this app provides digital “walls” for people to post their messages anonymously.',
    intro: 'Taking inspiration from the ‘Before I Die’ global art project, this app provides digital “walls” for people to post their messages anonymously & read what others have written.',
...
},
{
    ...
    shortIntro: 'A web application for users to save and "devour" delicious burgers!',
...
},
{
    ...
    shortIntro:'A simple but beautiful way to display the weather and forecast.',
    intro: `This weather dashboard lets you search cities and display their current weather and forecast. Mobile friendly design is ideal to search the weather on the go, it is also perfect to display at TV size in offices or travel agencies. Your search history is automatically saved so you're favourite cities are always just a click away.`,
...
},
{
    ...
    shortIntro: 'A website for travellers planning their trip, with a handy dashboard.',
...
},
{
    ...
    technologies: ['HTML', 'CSS', 'Javascript', 'Bootstrap', 'JQuery'],
    shortIntro:'Keep track of your daily plan and tasks with this desktop planner.',
...
},
{
    ...
    shortIntro:'Brush up on HTML, CSS and Javascript, the FUN way!',
